...
\begin{figure}[h]
\begin{center}
		\includegraphics[width=70mm]{figures/holyer_coord.png}
		\includegraphics[width=70mm]{figures/holyer_3_4.png}
\end{center}
		\caption{$H_{3,3} $ and $H_{3,4}$, the torus is embedded in the 2 dimensional plane.}
		\label{holyer}
\end{figure}
...
\begin{figure}[h]
\begin{center}
		\includegraphics[width=70mm]{figures/colour_holyer_coord.png}
		\includegraphics[width=70mm]{figures/colour_holyer.png}
\end{center}
		\caption{3-colouring of $H_{3,3} $ and $H_{3,4}$ }
		\label{holyercolour}
\end{figure}
...
\begin{figure}[h]
\begin{center}
		\includegraphics[width=70mm]{figures/holyer_true_triangulation.png}
		\includegraphics[width=70mm]{figures/holyer_false_triangulation.png}
\end{center}
		\caption{True triangulation and a False triangulation }
		\label{truefalsetri}
\end{figure}
...
Similarly if  $l_{i,j}=\neg b_i$ then $G_{i,j}$ is a false triangulation or $G_{b_k}$ is a true triangulation.
...
\subsection{Solving Sudoku is Hard}
